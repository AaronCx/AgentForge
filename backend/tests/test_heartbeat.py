...
class TestHeartbeatService:
    ...
    def test_update_partial_fields(self):
        ...
        _mock_supabase_client.table.return_value.update.return_value.eq.return_value.execute.return_value = MagicMock()
        self.service.update("hb-1", state="running", current_step=2)
        call_args = _mock_supabase_client.table.return_value.update.call_args[0][0]
    ...
    def test_update_noop_when_empty(self):
        ...
        _mock_supabase_client.table.return_value.update.reset_mock()
        self.service.update("hb-1")
        _mock_supabase_client.table.return_value.update.assert_not_called()
    ...
    def test_get_active(self):
        ...
        _mock_supabase_client.table.return_value.select.return_value.in_.return_value.order.return_value.execute.return_value = MagicMock(
    ...
    def test_detect_stalled(self):
        ...
        _mock_supabase_client.table.return_value.select.return_value.in_.return_value.lt.return_value.execute.return_value = MagicMock(
    ...
    def test_get_metrics(self):
        ...
        # Active count
        _mock_supabase_client.table.return_value.select.return_value.in_.return_value.execute.return_value = MagicMock(
            count=3
        )
        # Today's data
        _mock_supabase_client.table.return_value.select.return_value.gte.return_value.execute.return_value = MagicMock(
            count=5, data=[{"tokens_used": 100, "cost_estimate": 0.01}]
        )
        # Total agents
        _mock_supabase_client.table.return_value.select.return_value.execute.return_value = MagicMock(
            count=10
        )
